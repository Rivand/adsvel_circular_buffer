...
namespace adsvel {
template <class T, size_t size_> class CircularBuffer {
public:
...
template <class T, size_t size_> inline T &CircularBuffer<T, size_>::front() {
...
template <class T, size_t size_> inline bool CircularBuffer<T, size_>::empty() const noexcept {
